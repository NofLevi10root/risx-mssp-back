const { GetAlertFileData, UpdateAlertFileData,UpdateAlertState,GetAlertsConfig,UpdateAlertConfig,GetAllAlertsMonitor,ClearAlertDataChange } = require("../controllers/AlettController");
